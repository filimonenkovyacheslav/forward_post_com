...
class PhilIndRolesController extends AdminController
{
	...
	public function showAdd()
	{
		...
		$title = 'Add user';
		return view('admin.phil_ind.phil_ind_user_add', ['title' => $title, 'roles_arr' => $roles_arr]);
	}
	...
	public function add(Request $request)
	{
		...
		return redirect()->route('adminPhilIndUsers');
	}
	...
	public function show($id)
	{
		...
		return view('admin.phil_ind.phil_ind_user_update', ['title' => $title,'user' => $user, 'roles_arr' => $roles_arr]);
	}
