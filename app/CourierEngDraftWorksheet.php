...
{   
    ...
    */
    ...
    /**
    * Get the updates archive associated with the eng draft.
    */
    public function updatesArchive()
    {
        return $this->hasOne('App\UpdatesArchive','eng_draft_id');
    }
    ...
    /**
    * Get the signed documents associated with the eng draft.
    */
    public function signedDocuments()
    {
        return $this->hasMany('App\SignedDocument','eng_draft_id');
    }
