			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">					
						...
						{!! Form::open(['url'=>route('changeNewStatusDate'), 'class'=>'form-horizontal worksheet-add-form','method' => 'POST']) !!}

						<div class="form-group">
							{!! Form::label('date','Выберите дату партии',['class' => 'col-md-2 control-label'])   !!}
							<div class="col-md-8">
