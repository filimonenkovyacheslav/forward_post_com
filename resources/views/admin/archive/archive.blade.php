			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="btn-move-wrapper" style="display:flex">
						<form action="{{ route('archiveFilter') }}" method="GET" id="form-worksheet-table-filter" enctype="multipart/form-data">
							@csrf
						...
						<div class="table-container">
							...
							<table class="table table-striped table-bordered">
								...
								<tbody>
									...
									@if(isset($archive_obj))
									@foreach($archive_obj as $row)
							...
							@if(isset($data))
							{{ $archive_obj->appends($data)->links() }}
							@else
							{{ $archive_obj->links() }}
							@endif							
...
<!-- Modal -->
<a id="import-data" data-toggle="modal" data-target="#importDataModal"></a>

<div class="modal fade" id="importDataModal" tabindex="-1" role="dialog" aria-labelledby="importDataModalLabel" aria-hidden="true" style="background: rgba(0, 0, 0, 0.4);">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="importDataModalLabel">Import data from Work Sheet</h5>
					...
					<div class="form-group">
						<label class="control-label">From
							<select class="form-control" name="table_name">
								<option value="new_worksheet">Новый рабочий лист</option>
								<option value="phil_ind_worksheet">Work Sheet</option>
							</select>
						</label>
						<label class="control-label">Enter the date until which the data will be imported
