						...
						<div class="table-container">
							...
							<table class="table table-striped table-bordered">
								...
								<tbody>
									...
									@if(isset($worksheet_arr))
									@for($i=0; $i < count($worksheet_arr); $i++)
									@foreach($worksheet_arr[$i] as $row)
									...
									<tr class="{{$row->background}}">
										...
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->shipper_name}}">
											<div data-name="shipper_name" data-id="{{ $row->id }}" class="div-3">{{$row->shipper_name}}</div>
										</td>
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->shipper_country}}">
										...
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->shipper_city}}">
											<div data-name="shipper_city" data-id="{{ $row->id }}" class="div-3">{{$row->shipper_city}}</div>
										</td>
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->passport_number}}">
											<div data-name="passport_number" data-id="{{ $row->id }}" class="div-3">{{$row->passport_number}}</div>
										</td>
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->return_date}}">
											<div data-name="return_date" data-id="{{ $row->id }}" class="div-3">{{$row->return_date}}</div>
										</td>
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->shipper_address}}">
										...
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->shipper_phone}}">
											<div data-name="shipper_phone" data-id="{{ $row->id }}" class="div-3">{{$row->shipper_phone}}</div>
										</td>
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->shipper_id}}">
											<div data-name="shipper_id" data-id="{{ $row->id }}" class="div-3">{{$row->shipper_id}}</div>
										</td>
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->consignee_name}}">
											<div data-name="consignee_name" data-id="{{ $row->id }}" class="div-3">{{$row->consignee_name}}</div>
										</td>
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->consignee_country}}">
											<div data-name="consignee_country" data-id="{{ $row->id }}" class="div-3">{{$row->consignee_country}}</div>
										</td>
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->house_name}}">
											<div data-name="house_name" data-id="{{ $row->id }}" class="div-3">{{$row->house_name}}</div>
										</td>
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->post_office}}">
										...
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->state_pincode}}">
											<div data-name="state_pincode" data-id="{{ $row->id }}" class="div-3">{{$row->state_pincode}}</div>
										</td>
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->consignee_address}}">
											<div data-name="consignee_address" data-id="{{ $row->id }}" class="div-3">{{$row->consignee_address}}</div>
										</td>
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->consignee_phone}}">
											<div data-name="consignee_phone" data-id="{{ $row->id }}" class="div-3">{{$row->consignee_phone}}</div>
										</td>
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->consignee_id}}">
											<div data-name="consignee_id" data-id="{{ $row->id }}" class="div-3">{{$row->consignee_id}}</div>
										</td>
										<td class="@can('editColumns-eng-2')allowed-update @endcan" title="{{$row->shipped_items}}">
											<div data-name="shipped_items" data-id="{{ $row->id }}" class="div-3">{{$row->shipped_items}}</div>
										</td>
										<td class="@can('editPost')allowed-update @endcan" title="{{$row->shipment_val}}">
